"""
Game Catalog Service Database Models
"""
from sqlalchemy import Column, Integer, String, DateTime, Boolean, Text, Float, ForeignKey, Table, Index
...
# Association table for game genres
game_genres = Table(
    'game_genres',
    Base.metadata,
...
# Association table for game platforms
